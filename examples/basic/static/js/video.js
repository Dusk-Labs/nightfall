...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.videojs = factory(global.window, global.document));
  ...
  function findPosition(el) {
    ...
    var docEl = document__default['default'].documentElement;
    var body = document__default['default'].body;
    var clientLeft = docEl.clientLeft || body.clientLeft || 0;
    var scrollLeft = window__default['default'].pageXOffset || body.scrollLeft;
    var left = box.left + scrollLeft - clientLeft;
    var clientTop = docEl.clientTop || body.clientTop || 0;
    var scrollTop = window__default['default'].pageYOffset || body.scrollTop;
  ...
  var Component = /*#__PURE__*/function () {
    ...
    function Component(player, options, ready) {
      ...
      if (!window__default['default'].Set) {
      ...
      this.setTimeoutIds_ = window__default['default'].Set ? new Set() : new SetSham();
      this.setIntervalIds_ = window__default['default'].Set ? new Set() : new SetSham();
      this.rafIds_ = window__default['default'].Set ? new Set() : new SetSham();
  ...
  var TOUCH_ENABLED = isReal() && ('ontouchstart' in window__default['default'] || window__default['default'].navigator.maxTouchPoints || window__default['default'].DocumentTouch && window__default['default'].document instanceof window__default['default'].DocumentTouch);
  /**
  ...
  createXHR.XMLHttpRequest = window__default['default'].XMLHttpRequest || noop;
  createXHR.XDomainRequest = "withCredentials" in new createXHR.XMLHttpRequest() ? createXHR.XMLHttpRequest : window__default['default'].XDomainRequest;
  ...
  var TEXTAREA_ELEMENT = document__default['default'].createElement("textarea");
  var TAG_NAME = {
    c: "span",
    i: "i",
    b: "b",
  ...
  var browserIndex = createCommonjsModule(function (module) {
    ...
    window__default['default'].vttjs = vttjs;
    window__default['default'].WebVTT = vttjs.WebVTT;
    var cueShim = vttjs.VTTCue;
    var regionShim = vttjs.VTTRegion;
    var nativeVTTCue = window__default['default'].VTTCue;
    var nativeVTTRegion = window__default['default'].VTTRegion;

    vttjs.shim = function () {
      window__default['default'].VTTCue = cueShim;
      window__default['default'].VTTRegion = regionShim;
    };

    vttjs.restore = function () {
      window__default['default'].VTTCue = nativeVTTCue;
      window__default['default'].VTTRegion = nativeVTTRegion;
    };

    if (!window__default['default'].VTTCue) {
      vttjs.shim();
    }
  });
  browserIndex.WebVTT;
  ...
  var PictureInPictureToggle = /*#__PURE__*/function (_Button) {
    ...
    function PictureInPictureToggle(player, options) {
      ...
      if (!document__default['default'].pictureInPictureEnabled) {
        _this.disable();
      }
  ...
  var VolumePanel = /*#__PURE__*/function (_Component) {
    ...
    _proto.handleMouseOver = function handleMouseOver(event) {
      ...
      on(document__default['default'], 'keyup', bind(this, this.handleKeyPress));
    }
    /**
    ...
    _proto.handleMouseOut = function handleMouseOut(event) {
      ...
      off(document__default['default'], 'keyup', bind(this, this.handleKeyPress));
    }
    /**
  ...
  var MenuButton = /*#__PURE__*/function (_Component) {
    ...
    function MenuButton(player, options) {
      ...
      _this.on(_this.menuButton_, 'mouseenter', function () {
        ...
        on(document__default['default'], 'keyup', bind(assertThisInitialized(_this), _this.handleMenuKeyUp));
      });
    ...
    _proto.handleMouseLeave = function handleMouseLeave(event) {
      this.removeClass('vjs-hover');
      off(document__default['default'], 'keyup', bind(this, this.handleMenuKeyUp));
    }
    /**
  ...
  var LiveTracker = /*#__PURE__*/function (_Component) {
    ...
    function LiveTracker(player, options) {
      ...
      if (IE_VERSION && 'hidden' in document__default['default'] && 'visibilityState' in document__default['default']) {
        _this.on(document__default['default'], 'visibilitychange', _this.handleVisibilityChange);
      }
    ...
    _proto.dispose = function dispose() {
      this.off(document__default['default'], 'visibilitychange', this.handleVisibilityChange);
      this.stopTracking();
